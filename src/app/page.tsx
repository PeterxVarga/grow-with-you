...
function HeroSection() {
  /*
   * BlobBlue viewBox: 151 × 153  → rendered: 230 × 233
   *   scaleX = 230/151 ≈ 1.523   scaleY = 233/153 ≈ 1.523
   * BlobCoral viewBox: 200 × 200 → rendered: 240 × 240
   *   scale = 240/200 = 1.2
   */
  return (
    <section className="relative w-full bg-bg-cream min-h-[90svh] flex items-center justify-center overflow-hidden px-4 py-24 md:py-0">
      ...
      <svg width="0" height="0" className="absolute" aria-hidden="true">
        <defs>
          {/* BlobBlue path scaled from 151×153 viewBox to 230×233 px */}
          ...
          {/* BlobCoral path scaled from 200×200 viewBox to 240×240 px */}
      ...
      {/* ─── Left image: Hero 1 clipped to BlobBlue ─── */}
      <div
        className="hidden md:block absolute"
        style={{
          left: "clamp(0px, calc(50% - 580px), 60px)",
          top: "50%",
      ...
      {/* ─── Right image: Hero 2 clipped to BlobCoral ─── */}
      <div
        className="hidden md:block absolute"
        style={{
          right: "clamp(0px, calc(50% - 580px), 60px)",
          top: "50%",
          transform: "translateY(-50%)",
          width: 240,
          height: 240,
      ...
      <SmileDoodle
        ...
        style={{
          left: "clamp(40px, calc(50% - 490px), 180px)",
          top: "28%",
          width: 80,
          opacity: 0.9,
        } as React.CSSProperties}
      />
      {/* SparkleAccent — jobb, badge közelében */}
      <SparkleAccent
        className="hidden md:block absolute pointer-events-none"
        style={{
          right: "clamp(260px, calc(50% - 140px), 400px)",
          top: "22%",
          width: 88,
          opacity: 0.9,
        } as React.CSSProperties}
      ...
      {/* ── Center content ── */}
      <div className="relative z-10 flex flex-col items-center text-center max-w-[700px] gap-8">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border-badge bg-white/70 backdrop-blur-sm">
          <span className="text-brand-coral-dark text-base leading-none" aria-hidden="true">✦</span>
          <span className="font-caveat text-base tracking-[-0.32px] leading-6 text-text-main uppercase">
            Hamarosan indulunk
          </span>
        </div>
        ...
        {/* Description */}
        <p className="font-source-sans font-normal text-text-muted
    ...
    <section className="bg-bg-beige">
      <div className="max-w-[1200px] mx-auto px-4 py-20 md:py-32 flex flex-col items-center text-center gap-16 md:gap-20">
        ...
        <div className="flex flex-col items-center gap-6 max-w-[900px]">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border-badge bg-white">
            <span className="text-brand-coral-dark text-base leading-none" aria-hidden="true">✦</span>
            <span className="font-caveat text-base tracking-[-0.32px] leading-6 text-text-main uppercase">
