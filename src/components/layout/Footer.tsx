                ...
                <div className="relative">
                  <WaitlistButton
                    ...
                    className="
                      ...
                      whitespace-nowrap relative z-10 shadow-sm cursor-pointer
                    "
                  >
          ...
          >
            ...
            >
              <div className="flex items-center gap-5 text-[#a37989]">
                {/* Facebook icon */}
                <a href="#" aria-label="Facebook" className="hover:text-[#302244] transition-colors cursor-pointer">
                ...
                {/* Instagram icon */}
                <a href="#" aria-label="Instagram" className="hover:text-[#302244] transition-colors cursor-pointer">
                ...
                {/* X / Twitter icon */}
                <a href="#" aria-label="X (Twitter)" className="hover:text-[#302244] transition-colors cursor-pointer">
              ...
              <a
                ...
                className="
                  ...
                  text-text-desc hover:text-[#302244] transition-colors cursor-pointer
                "
              >
